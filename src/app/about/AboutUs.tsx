    ...
    <div className="bg-white">
        ...
        <div className="container md:gap-8 mx-auto flex px-5 py-24">
          ...
          <div className="md:block hidden md:flex-row items-center md:space-x-4 mt-2 ml-2">
            <Image
              ...
              alt="hero"
              src= "/hero.png" width={309} height={536} 
            />
          </div>
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <div className="flex justify-center">
              <button className="inline-flex text-[#FFFFFF] font-bold bg-[#FF9F0D] border-0 py-2 px-6 focus:outline-none rounded text-lg">
                Show More
              </button>
      ...
      <section className="text-black body-font">
        <div className="container mx-auto flex items-center justify-center flex-col">
            <h1 className="text-black text-3xl text-bold mt-3 font-bold">Why Choose Us</h1>
            <p className="text-black text-center mt-2 w-[579px]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam 
              pellentesque bibendum non dui volutpat fringilla bibendum.
            </p>
            <Image
              className="mb-10 md:w-[2530%] md:h-[400px] md:mt-[12px] mt-10"
              alt="hero"
              src = "/about.png"
