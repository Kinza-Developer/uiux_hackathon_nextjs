...
const Categories = () => {
  return (
    ...
    <div className='bg-black h-2000px] '>
      ...
      {/* Food Category Title */}
      <p className={`${VibeFont.className} text-[#FF9F0D] md:ml-[630px] leading-[30px] md:w-[177px] font-normal text-[25px] md:h-[40px]  ml-[10px]`}>
        Food Category
      </p>
          ...
          <div className="flex my-[20px] md:gap-0 gap-[45px] md:ml-0 ml-[10px] md:mx-0 mx-[10px] md:my-[40px] md:bg-none bg-[#FF9F0D] md:p-0 p-[10px]">
            ...
            <div className="flex flex-col ">
              <p className="bg-[#FF9F0D] md:w-[102px] md:h-[100px] rounded-[6px] md:mr-[30px]">
                <Image src='/Hamburger.png' alt="humberger-icon" width={56} height={56} className="md:m-[20px]" />
              </p>
            ...
            <div className="flex flex-col ">
              <p className="bg-[#FF9F0D] md:w-[102px] md:h-[100px] rounded-[6px] md:mr-[30px]">
                <Image src='/Cookie.png' alt="cookie-icon" width={56} height={56} className="md:m-[20px]" />
              </p>
            ...
            <div className="flex flex-col">
              <p className="bg-[#FF9F0D] md:w-[102px] md:h-[100px] rounded-[6px] md:mr-[30px]">
                <Image src='/Wine.png' alt="wine-icon" width={56} height={56} className="md:m-[20px]" />
              </p>
